            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('jobs') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Cars</a></li>
                    </ol>
                </nav>
            </div>
        </div> 
            ...
            <div class="col-md-4">
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                @if ($job->salary)
                                <li>Rent: <span>{{ $job->salary }}</span></li>
                            @endif

                                
                                <li>Location: <span>{{ $job->location}}</span></li>
                                <li>Car Nature: <span> {{ $job->jobType->name }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="card shadow border-0 my-4">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                <li>Contact: <span>{{ $job->company_name }}</span></li>

                                @if ($job->company_location)
                                <li>Address: <span>{{ $job->company_location }}</span></li>
                            @endif
